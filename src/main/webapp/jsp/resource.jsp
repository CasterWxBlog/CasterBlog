                ...
                <div class="resource-main">
                    <div class="resource shadow">
                        <div class="resource-cover">
                            <a href="javascript:layer.msg(&#39;http://120.78.134.109&#39;)" target="_blank">
                                <img src="../images/cover/resource.png" alt="CasterWx" />
                            </a>
                        </div>
                        <h1 class="resource-title"><a href="javascript:layer.msg(&#39;http://120.78.134.109&#39;)" target="_blank">CasterWx</a></h1>
                        <p class="resource-abstract">本博客源代码,开源于Github</p>
                        <div class="resource-info">
                            <span class="category"><a href="javascript:layer.msg(&#39;https://github.com/CasterWxBlog/CasterBlog&#39;)"><i class="fa fa-tags fa-fw"></i>&nbsp;源码</a></span>
                            <span class="author"><i class="fa fa-user fa-fw"></i>AntzUhl</span>
                            <div class="clear"></div>
                        </div>
                        <div class="resource-footer">
                            <a class="layui-btn layui-btn-small layui-btn-primary" href="javascript:layer.msg(&#39;http://120.78.134.109&#39;)" target="_blank"><i class="fa fa-eye fa-fw"></i>演示</a>
                            <a class="layui-btn layui-btn-small layui-btn-primary" href="javascript:layer.msg(&#39;https://github.com/CasterWxBlog/CasterBlog&#39;)" target="_blank"><i class="fa fa-download fa-fw"></i>下载</a>
                        </div>
                    </div>
                    <!-- 清除浮动 -->
                    <div class="clear"></div>
